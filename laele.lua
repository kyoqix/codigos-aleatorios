...
local function notify(text)
	...
	addCorner(notification, 7)
	addStroke(notification, theme.borderActive, 1, 0.15)
	...
	addCorner(icon, 6)
	addStroke(icon, theme.borderActive, 1, 0.25)
	...
	notification.Position = UDim2.fromOffset(22, 8)
