...
local theme = {
	background = Color3.fromRGB(34, 22, 52),
	surface = Color3.fromRGB(66, 46, 98),
	surfaceAlt = Color3.fromRGB(80, 57, 118),
	elevated = Color3.fromRGB(95, 68, 140),
	hover = Color3.fromRGB(111, 81, 161),
	selection = Color3.fromRGB(126, 94, 182),
	input = Color3.fromRGB(48, 34, 72),
	active = Color3.fromRGB(198, 158, 255),
	accent = Color3.fromRGB(198, 158, 255),
	accentSoft = Color3.fromRGB(142, 106, 204),
	accentBright = Color3.fromRGB(245, 236, 255),
	text = Color3.fromRGB(255, 251, 255),
	subtext = Color3.fromRGB(235, 226, 247),
	dim = Color3.fromRGB(206, 190, 228),
	border = Color3.fromRGB(140, 111, 183),
	borderActive = Color3.fromRGB(202, 170, 247)
}
...
create("UIGradient", {
	Color = ColorSequence.new({
		...
		ColorSequenceKeypoint.new(0.52, Color3.fromRGB(64, 44, 98)),
		ColorSequenceKeypoint.new(1, Color3.fromRGB(93, 67, 136))
	}),
	Rotation = 125
}, root)
