...
local theme = {
	background = Color3.fromRGB(6, 4, 10),
	surface = Color3.fromRGB(12, 8, 18),
	surfaceAlt = Color3.fromRGB(17, 11, 25),
	elevated = Color3.fromRGB(21, 14, 31),
	hover = Color3.fromRGB(27, 18, 40),
	selection = Color3.fromRGB(31, 20, 47),
	input = Color3.fromRGB(9, 6, 14),
	active = Color3.fromRGB(116, 75, 183),
	accent = Color3.fromRGB(116, 75, 183),
	accentSoft = Color3.fromRGB(70, 43, 108),
	accentBright = Color3.fromRGB(171, 128, 235),
	text = Color3.fromRGB(240, 236, 246),
	subtext = Color3.fromRGB(174, 164, 187),
	dim = Color3.fromRGB(103, 92, 117),
	border = Color3.fromRGB(47, 34, 62),
	borderActive = Color3.fromRGB(94, 61, 135)
}
...
create("UIGradient", {
	Color = ColorSequence.new({
		...
		ColorSequenceKeypoint.new(0.52, Color3.fromRGB(8, 5, 13)),
		ColorSequenceKeypoint.new(1, Color3.fromRGB(11, 7, 17))
	}),
	Rotation = 125
}, root)
...
local content = create("Frame", {
	...
	Position = UDim2.fromOffset(138, 42),
	BackgroundColor3 = theme.background,
...
local function notify(text)
	...
	addStroke(notification, theme.borderActive, 1, 0.12)

	create("UIGradient", {
		Color = ColorSequence.new({
			ColorSequenceKeypoint.new(0, Color3.fromRGB(28, 19, 42)),
			ColorSequenceKeypoint.new(0.55, Color3.fromRGB(21, 14, 31)),
			ColorSequenceKeypoint.new(1, Color3.fromRGB(15, 10, 23))
		}),
		Rotation = 0
	}, notification)
	...
	create("TextLabel", {
		...
		Position = UDim2.fromOffset(61, 10),
		BackgroundTransparency = 1,
		Text = "K27E",
		TextColor3 = theme.text,
		TextSize = 12,
	...
	create("TextLabel", {
		...
		Position = UDim2.fromOffset(61, 28),
		BackgroundTransparency = 1,
		Text = text,
		TextColor3 = theme.subtext,
		TextSize = 11,
