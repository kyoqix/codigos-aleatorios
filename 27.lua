...
local theme = {
	background = Color3.fromRGB(24, 15, 38),
	surface = Color3.fromRGB(42, 28, 63),
	surfaceAlt = Color3.fromRGB(54, 36, 80),
	elevated = Color3.fromRGB(66, 44, 96),
	hover = Color3.fromRGB(81, 56, 118),
	selection = Color3.fromRGB(94, 66, 136),
	input = Color3.fromRGB(31, 21, 47),
	active = Color3.fromRGB(170, 112, 255),
	accent = Color3.fromRGB(170, 112, 255),
	accentSoft = Color3.fromRGB(108, 73, 163),
	accentBright = Color3.fromRGB(225, 205, 255),
	text = Color3.fromRGB(248, 243, 255),
	subtext = Color3.fromRGB(223, 211, 241),
	dim = Color3.fromRGB(178, 160, 206),
	border = Color3.fromRGB(100, 72, 141),
	borderActive = Color3.fromRGB(156, 118, 214)
}
...
create("UIGradient", {
	Color = ColorSequence.new({
		...
		ColorSequenceKeypoint.new(0.52, Color3.fromRGB(39, 25, 59)),
		ColorSequenceKeypoint.new(1, Color3.fromRGB(55, 36, 82))
	}),
	Rotation = 125
}, root)
...
local function setTabVisual(name, selected)
	...
	playTween(tab.button, {
		...
		BackgroundTransparency = selected and 0.08 or 0.45
	}, 0.22)
